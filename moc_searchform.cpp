...
static constexpr auto qt_meta_stringdata_CLASSSearchFormENDCLASS = QtMocHelpers::stringData(
    "SearchForm"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSSearchFormENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSSearchFormENDCLASS_t qt_meta_stringdata_CLASSSearchFormENDCLASS = {
    {
        QT_MOC_LITERAL(0, 10)   // "SearchForm"
    },
    "SearchForm"
};
